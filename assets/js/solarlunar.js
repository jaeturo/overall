/*!
 * solarlunar.js
 * https://github.com/isee15/solarlunar
 * MIT License
 */
(function(window) {
  'use strict';
  ...
  var solarlunar = {
    ...
    toSolarDateString: function(y, m, d) {
      var res = lunar2solar(y, m, d, false);
      return res.solarYear + '-' + pad(res.solarMonth) + '-' + pad(res.solarDay);
    },
    toLunarDateString: function(y, m, d) {
      var res = solar2lunar(y, m, d);
      var leapMark = res.isLeap ? ' (윤달)' : '';
      return res.lunarYear + '-' + pad(res.lunarMonth) + '-' + pad(res.lunarDay) + leapMark;
    }
  };
